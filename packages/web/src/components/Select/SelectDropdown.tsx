...
const SelectDropdown = ({ backgroundColor, color, options, onChange, ...props }: SelectDropdownProps) => {
  ...
  if (isOpen) {
    return (
      <div className={styles.dropdown} style={{ backgroundColor: getColor(backgroundColor, 'white') }} {...props}>
