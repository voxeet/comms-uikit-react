...
const SvgMicrophoneOffGradient = (props: SVGComponent) => (
  <svg
    width="100%"
    height="100%"
    viewBox="0 0 24 24"
  ...
  >
    <path
      fill="url(#microphone-off-gradient_svg__a)"
    ...
    />
    <defs>
      <linearGradient id="microphone-off-gradient_svg__a" x1={0} y1={0} x2={24} y2={0} gradientUnits="userSpaceOnUse">
...
export default SvgMicrophoneOffGradient;
